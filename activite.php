...
<head>
    ...
    <title>Activités à Dakhla</title>
...
<header class="bg-white shadow">
    ...
    <div id="mobile-menu" class="hidden md:hidden">
        <nav class="px-6 py-4">
            ...
            <a class="block text-gray-600 hover:text-gray-800 py-2" href="exursion.php">Excursions</a>
            <a class="block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded mt-4" href="inscription.php">Connexion</a>
        </nav>
    </div>
</header>
<main>
    <section class="container mx-auto py-12 px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-4">
                    <h3 class="text-lg font-semibold text-gray-800">Safari en 4x4</h3>
                    <p class="mt-2 text-gray-600">Explorez les dunes de sable et les paysages désertiques de Dakhla en 4x4.</p>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-4">
                    <h3 class="text-lg font-semibold text-gray-800">Excursion en bateau</h3>
                    <p class="mt-2 text-gray-600">Profitez d'une excursion en bateau pour découvrir la baie de Dakhla et ses environs.</p>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-4">
                    <h3 class="text-lg font-semibold text-gray-800">Kitesurf</h3>
                    <p class="mt-2 text-gray-600">Apprenez le kitesurf dans l'un des meilleurs spots au monde avec des instructeurs qualifiés.</p>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <img alt="Activité 4 à Dakhla" class="w-full h-48 object-cover" height="200" src="https://storage.googleapis.com/a1aa/image/4x4.jpg" width="400"/>
                <div class="p-4">
                    <h3 class="text-lg font-semibold text-gray-800">Randonnée à dos de chameau</h3>
                    <p class="mt-2 text-gray-600">Découvrez le désert de Dakhla à dos de chameau et vivez une expérience authentique.</p>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <img alt="Activité 5 à Dakhla" class="w-full h-48 object-cover" height="200" src="https://storage.googleapis.com/a1aa/image/boat.jpg" width="400"/>
                <div class="p-4">
                    <h3 class="text-lg font-semibold text-gray-800">Pêche en mer</h3>
                    <p class="mt-2 text-gray-600">Partez pour une journée de pêche en mer et attrapez des poissons exotiques.</p>
                </div>
            </div>
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <img alt="Activité 6 à Dakhla" class="w-full h-48 object-cover" height="200" src="https://storage.googleapis.com/a1aa/image/kitesurf.jpg" width="400"/>
                <div class="p-4">
                    <h3 class="text-lg font-semibold text-gray-800">Observation des oiseaux</h3>
                    <p class="mt-2 text-gray-600">Observez les nombreuses espèces d'oiseaux migrateurs qui visitent la région de Dakhla.</p>
                </div>
            </div>
        </div>
    </section>
